...
import casariego.jorge.displaylargebitmaps.imagegrid.detalle.ImageDetailActivity;
import casariego.jorge.displaylargebitmaps.imagegrid.util.BuildConfig;
import casariego.jorge.displaylargebitmaps.imagegrid.util.ImageCache;
...
import casariego.jorge.displaylargebitmaps.imagegrid.util.Utils;

/**
 * A simple {@link Fragment} subclass.
 */
public class ImageGridFragment extends Fragment implements ImageGridContract.View, AdapterView.OnItemClickListener{

    private ImageGridContract.Presenter mPresenter;
    ...
    @Override
    public void setPresenter(ImageGridContract.Presenter presenter) {
        if(presenter != null){
